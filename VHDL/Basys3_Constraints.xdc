...
## Switches
set_property PACKAGE_PIN V17 [get_ports morse_sci_rx_sw_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports morse_sci_rx_sw_ext_port]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports sci_tx_done_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports sci_tx_done_ext_port]
...
##Pmod Header JA
##Sch name = JA1
set_property PACKAGE_PIN J1 [get_ports morse_tx_ext_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports morse_tx_ext_port]
##Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports sci_tx_osc_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports sci_tx_osc_port]
##Sch name = JA3
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports morse_tx_osc_port]					
	set_property IOSTANDARD LVCMOS33 [get_ports morse_tx_osc_port]
##Sch name = JB2
...
set_property PACKAGE_PIN A18 [get_ports sci_tx_ext_port]						
